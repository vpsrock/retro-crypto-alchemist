...
// For closing a position by placing an opposite market order
export async function closePosition(
    settle: 'usdt' | 'btc',
    contract: string,
    size: string, // Absolute size to close
    isLong: boolean, // True if closing a long position, false for short
    apiKey: string,
    apiSecret: string
) {
    const order = {
